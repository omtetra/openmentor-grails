...
<html>
    ...
    <body>
        ...
        <div class="body">
            ...
            <div class="textheading">What is Open Mentor?</div>
    <div class ="para">
    ...
    <div class="textheading">How does it work in practice?</div>
    <div class ="para">
      ...
      with part of an assignment.  <br/><br/> Open Mentor works by
      ...
      to the tutor.  <br/><br/> <strong>Table 1: Bales' Interaction
      Process used for the analysis in OpenMentor</strong>
    </div>
    <div class="para">&nbsp;</div>
    ...
    <br/><br/>
    <div class="textheading">What can it tell you?</div>
    <a name="groupA"></a>
    ...
    <p>
      <img src="images/commentA_graph_1.jpg" 
    ...
    <p>
      <img src="images/commentB_graph_1.jpg" 
    ...
    <p>
      <img src="images/commentC_graph_1.jpg" 
    ...
    <p>
      <img src="images/commentD_graph_1.jpg" 
    ...
    <div class="textheading">When can it be used?</div>
