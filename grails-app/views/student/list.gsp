                ...
                <table class="table table-striped">
                    ...
                    <g:each in="${studentInstanceList}" status="i" var="studentInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>
                                <g:link class="btn btn-info btn-small" action="show" params="${[studentId: fieldValue(bean: studentInstance, field: 'studentId')]}">${message(code: 'default.button.show.label', default: 'Show')}</g:link>
