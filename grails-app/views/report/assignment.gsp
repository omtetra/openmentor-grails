...
<html>
    ...
    <body>
        ...
        <div class="body">
            ...
            <ul>
                <li><g:link action="assignments">Go back to the assignments view</g:link></li>
            </ul>
            ...
            <table id="assignment_placeholder-table" class="actual-ideal table table-striped table-condensed">
                <thead>
                    <tr> 
                        <td></td>
            ...
            <h4><g:link action="assignment_details" params="${[id: params.id]}">See detailed information</g:link></h4>
            </g:if>
        </div>
        </div>
        <g:javascript>
