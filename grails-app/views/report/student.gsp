...
<html>
    ...
    <body>
        ...
        <div class="body">
            ...
            <table id="student_placeholder-table" class="actual-ideal table table-striped table-condensed">
                <thead>
                    <tr> 
                        <td></td>
            ...
            <h4><g:link action="student_details" params="${[id: params.id]}">See detailed information</g:link></h4>
            </g:if>
        </div>
        </div>
        <g:javascript>
