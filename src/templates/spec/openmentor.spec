...
Version: 1.0.M6
Release: 1
Source0: openmentor-1.0.M6.tar.gz
License: ASL 2.0
...
install -m 0755 target/openmentor-1.0.M6.war $RPM_BUILD_ROOT/var/lib/tomcat6/webapps/
...
/var/lib/tomcat6/webapps/openmentor-1.0.M6.war
